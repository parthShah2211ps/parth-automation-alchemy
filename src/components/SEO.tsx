...
const SEO = ({
  ...
  useEffect(() => {
    ...
    updateMetaTag('keywords', 'Product Manager, n8n Automation, Full-Stack Developer, Technical PM, Workflow Automation, React Developer, Node.js, JavaScript, TypeScript, PostgreSQL');
    ...
    if (!structuredData && type === 'website') {
      const defaultStructuredData = {
        ...
        "image": image,
        "sameAs": [
          "https://linkedin.com/in/parth-shah",
        ...
        "hasOccupation": {
          ...
          "description": "Technical Product Manager specializing in automation and full-stack development"
        },
        "alumniOf": {
          "@type": "Organization",
